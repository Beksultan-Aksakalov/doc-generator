	...
	public class AutoRazmetka
    {
        public static Document getAutoDoc(PowerOfAttorneyAutoSaleDocument doc)
        {
            ...
            paragraphContent.AddFormattedText("\n Я, гражданин (ка) "
                + doc.DoveritelFullName + ", "
                + doc.DoveritelBirthDate + " г. р., уроженки "
                + doc.DoveritelBirthPlace + " /ИИН "
                + doc.DoveritelIIN + "/, проживающий (ая) по адресу: "
                + doc.DoveritelTheActualAddress + ". \n настоящей доверенностью уполномочиваю гр. "
                + doc.DoverenniiFullName + ", " 
                + doc.DoverenniiBirthDate + " г. р., "
                + doc.DoverenniiBirthPlace + " /ИИН "
                + doc.DoverenniiIIN + "/ проживающий по адресу: "
                + doc.DoverenniiTheActualAddress + ". ПРОДАТЬ принадлежащему мне на основании Свидетельство о регистрации ТС, выдано "
        ...
        public static Document getAutoSaleDoc(AutoSaleDocument doc)
        {
